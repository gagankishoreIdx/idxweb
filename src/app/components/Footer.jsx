      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-sora font-bold text-xl">Modern</span>
            </Link>
            
            <p className="text-gray-400 mb-6 max-w-md">
              We're building the next generation of digital experiences. Join us on this exciting journey.
            </p>
            
            <div className="flex space-x-4 mb-8">
              <a href="#" className="w-8 h-8 rounded-full bg-white-10 flex items-center justify-center hover:bg-purple-600-20 transition-colors">
        ...
        <div className="border-t border-white-10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {currentYear} Modern. All rights reserved.
          </p>
